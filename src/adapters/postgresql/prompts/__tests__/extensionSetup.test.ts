...
describe('Extension Setup Prompt', () => {
    ...
    describe('prompt definition', () => {
        ...
        it('should have extensionName argument', () => {
            ...
            expect(prompt.arguments?.some(arg => arg.name === 'extensionName')).toBe(true);
        });

        it('should have extensionName as required', () => {
            const extensionArg = prompt.arguments?.find(arg => arg.name === 'extensionName');
    ...
    describe('pg_stat_statements extension', () => {
        it('should return setup content', async () => {
            const content = await prompt.handler({ extensionName: 'pg_stat_statements' }, mockContext);
    ...
    describe('hypopg extension', () => {
        it('should return setup content', async () => {
            const content = await prompt.handler({ extensionName: 'hypopg' }, mockContext);
    ...
    describe('pgvector extension', () => {
        it('should return setup content', async () => {
            const content = await prompt.handler({ extensionName: 'pgvector' }, mockContext);
    ...
    describe('postgis extension', () => {
        it('should return setup content', async () => {
            const content = await prompt.handler({ extensionName: 'postgis' }, mockContext);
    ...
    describe('pg_cron extension', () => {
        it('should return setup content', async () => {
            const content = await prompt.handler({ extensionName: 'pg_cron' }, mockContext);
    ...
    describe('pg_partman extension', () => {
        it('should return setup content', async () => {
            const content = await prompt.handler({ extensionName: 'pg_partman' }, mockContext);
    ...
    describe('pg_stat_kcache extension', () => {
        it('should return setup content', async () => {
            const content = await prompt.handler({ extensionName: 'pg_stat_kcache' }, mockContext);
    ...
    describe('citext extension', () => {
        it('should return setup content', async () => {
            const content = await prompt.handler({ extensionName: 'citext' }, mockContext);
    ...
    describe('ltree extension', () => {
        it('should return setup content', async () => {
            const content = await prompt.handler({ extensionName: 'ltree' }, mockContext);
    ...
    describe('pgcrypto extension', () => {
        it('should return setup content', async () => {
            const content = await prompt.handler({ extensionName: 'pgcrypto' }, mockContext);
    ...
    describe('unknown extension', () => {
        it('should return generic content for unknown extension', async () => {
            const content = await prompt.handler({ extensionName: 'unknown_extension' }, mockContext);
            expect(content).toContain('unknown_extension');
        });

        it('should include generic configuration message', async () => {
            const content = await prompt.handler({ extensionName: 'some_other_ext' }, mockContext);
