...
describe('Tool Annotations', () => {
    ...
    beforeEach(() => {
        tools = getPostgisTools(createMockPostgresAdapter() as unknown as PostgresAdapter);
    });
...
describe('Error Handling', () => {
    ...
    it('should propagate database errors from extension check', async () => {
        ...
        await expect(tool.handler({}, mockContext)).rejects.toThrow('extension "postgis" is not available');
    });
});
