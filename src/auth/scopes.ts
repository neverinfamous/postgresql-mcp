 ...
 */
export function hasSchemaScope(grantedScopes: string[], schema: string): boolean {
 ...
 */
export function hasTableScope(grantedScopes: string[], schema: string, table: string): boolean {
