...
import { getToolIcons, getCategoryIcon, getAllCategoryIcons } from '../icons.js';
...
describe('Tool Icons Utility', () => {
    describe('getToolIcons', () => {
        ...
        it('should return admin icon for ANALYZE operations', () => {
            const icons = getToolIcons('admin', { title: 'Analyze Table Statistics' });
            expect(icons.length).toBe(1);
        });
    ...
    describe('getCategoryIcon', () => {
        const toolGroups: ToolGroup[] = [
            ...
            'kcache', 'citext', 'ltree', 'pgcrypto', 'codemode'
        ];
